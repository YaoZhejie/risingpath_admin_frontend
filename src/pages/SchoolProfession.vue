  ...
  <div class="table">
    <div class="container">
      ...
      <el-table :data="data" border size="mini" style="width: 100%" height="600px" ref="multipleTable">
        ...
        <el-table-column label="学校名" prop="schoolName" width="150" align="center"></el-table-column>
        ...
        <el-table-column label="学费" prop="tuition" width="100" align="center"></el-table-column>
        <el-table-column label="英语要求" prop="englishReq" width="180" align="center"></el-table-column>
        <el-table-column label="报考专业要求" prop="remarks" width="450" align="center">
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      getProfessinfoBySchoolId(queryForm).then(res => {
